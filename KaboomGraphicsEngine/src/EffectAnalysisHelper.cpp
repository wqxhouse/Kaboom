...
/* CompositorAnalysis Section */
    
CompositorAnalysis::CompositorAnalysis(osg::Camera* cam, osgFX::EffectCompositor* c, int numBuffers)
...
void CompositorAnalysis::toggleHelper()
{
...
void CompositorAnalysis::applyEffectGraph(osgFX::EffectCompositor* c, float x, float y, float w, float h)
{
	int numX = 1, numY = 0;
...
void CompositorAnalysis::applyUniformList(osgFX::EffectCompositor* c, float x, float y, float w, float h)
{
}

unsigned int CompositorAnalysis::applyBufferData(osgFX::EffectCompositor* c, int startIndex)
{
...
bool CompositorAnalysis::handle(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa)
{
	...
	case osgGA::GUIEventAdapter::KEYUP:
		// take out this branch. Let F9, F10 handle this
...
osg::ref_ptr<CompositorAnalysis> configureViewerForMode( osgViewer::Viewer& viewer, osgFX::EffectCompositor* compositor,
                             osg::Node* model, int displayMode )
{
	...
	osg::ref_ptr<CompositorAnalysis> handler = new CompositorAnalysis(camera, compositor);
