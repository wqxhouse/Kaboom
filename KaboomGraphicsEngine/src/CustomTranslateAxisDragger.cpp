...
CustomTranslateAxisDragger::CustomTranslateAxisDragger()
{
...
void CustomTranslateAxisDragger::setAxisLineWidth(float linePixelWidth)
{
	_axisLineWidth = linePixelWidth;
	if (_lineWidth.valid())
		_lineWidth->setWidth(linePixelWidth);
}
void CustomTranslateAxisDragger::setPickCylinderRadius(float pickCylinderRadius)
{
...
void CustomTranslateAxisDragger::setConeHeight(float height)
{
	_coneHeight = height;
	if (_cone.valid())
	{
