...
#ifndef OSGMANIPULATOR_CUSTOMTRANSLATEAXISDRAGGER
#define OSGMANIPULATOR_CUSTOMTRANSLATEAXISDRAGGER 1
...
namespace osgManipulator {
	...
	*/
	class CustomTranslateAxisDragger : public CompositeDragger 
	{
	public:
